...
<Steps>
  <Step>
    ...
    <InstallCommand
      items={[
        { value: "data-grid", label: "Core grid", defaultChecked: true },
        { value: "data-grid-toolbar", label: "Toolbar" },
        { value: "data-grid-sort-list", label: "Sort list" },
        { value: "data-grid-context-menu", label: "Context menu" },
        { value: "data-grid-keybindings", label: "Keybindings" },
        { value: "data-grid-history", label: "Undo & redo" },
        { value: "data-grid-fill", label: "Fill" },
        { value: "data-grid-pinned-rows", label: "Pinned rows" },
        { value: "data-grid-presence", label: "Presence" },
        { value: "data-grid-io", label: "Import / export" },
        { value: "data-grid-url-state", label: "URL state" },
        { value: "data-grid-lazy", label: "Lazy loading" },
        { value: "data-grid-pagination", label: "Pagination" },
      ]}
    />

    Check the pieces you want — the command joins them in one call. The package-manager tab
    (pnpm, npm, yarn, bun) is a choice: it is remembered across the whole docs site.

    The CLI resolves the `@gridcn` registry from the hosted site
    ([gridcn.vercel.app](https://gridcn.vercel.app)) — no setup step. To pin a specific tag,
...
<InstallCommand item="data-grid-history" />
...
to redo. See [Undo & redo](/docs/examples/addons/undo-redo) for the full add-on: a composable history hook,
