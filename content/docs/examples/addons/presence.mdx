...
[Fill handle](/docs/examples/addons/fill#composing-with-cores-datagrid-convenience-wrapper).
...
different local sort or filter paints it on the wrong cells. Use the rowId forms whenever
sender and receiver views can diverge:
...
[Broadcasting your selection](/docs/examples/addons/broadcasting-presence) page.
