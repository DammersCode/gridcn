...
([toolbar add-on: filter menu keyboard & accessibility](/docs/examples/addons/toolbar#filter-menu-keyboard--accessibility)),
to change it.

`DataGridFilterMenu`, along with the search input and columns menu below, comes from the
[toolbar add-on](/docs/examples/addons/toolbar), which owns the install, wiring, toolbar order,
...
[sort list add-on](/docs/examples/addons/sort-list).
