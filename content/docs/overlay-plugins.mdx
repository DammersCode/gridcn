...
[Multiplayer presence](/docs/multiplayer-presence#coordinates-rowid-native-or-view-space).
...
wire onto the handle square it renders. See [Fill handle](/docs/fill-handle) and
